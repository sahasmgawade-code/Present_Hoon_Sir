...
const {createFaculty, listFaculties, updateFaculty, toggleFacultyActive, deleteFaculty, addFacultyCollaborator, removeFacultyCollaborator, getFacultyBatchAccess, assignBatchToFaculty, revokeBatchFromFaculty} = require('../controllers/facultyController');
