...
// Public: faculty logs in with email + password
...
// Protected (faculty token): change own password
...
// Public: verify a set-password token is valid before showing the form
...
// Public: faculty sets their password using the emailed token
