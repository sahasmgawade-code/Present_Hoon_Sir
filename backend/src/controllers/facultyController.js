...
module.exports = {createFaculty, listFaculties, updateFaculty, toggleFacultyActive, deleteFaculty, addFacultyCollaborator, removeFacultyCollaborator, getFacultyBatchAccess, assignBatchToFaculty, revokeBatchFromFaculty};